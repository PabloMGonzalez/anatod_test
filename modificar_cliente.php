...
function lista_provincias(&$lista_p, &$nombre_provincia) {
    global $db;  
    $lista_p =  "<select disabled class='data1' id='provincia' name='provincia'>".
...
function lista_localidades(&$lista_l, &$nombre_localidad) {
    global $db;
    $lista_l =  "<select disabled class='data1' id='localidad' name='localidad'>".
...
<head>
    ...
    <script>
        function buscador () {
            var buscador = document.getElementById("buscar").innerHTML;
        ...
        <div class="formulario">
            <form id="datos" action="index.php" method="POST">
                <h1>Buscar Cliente <i class="fas fa-search-plus"></i></i></h1>
                    ...
                    <input class="daa1" type="text" id="buscar" name="buscar" placeholder="Buscar por DNI">
                    <input type="button" value="Buscar" class="boton data1">
            </form>
                    <br>
            <form id="datos2" action="index.php" method="POST">
